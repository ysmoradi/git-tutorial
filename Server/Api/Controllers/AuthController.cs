...
using MyCompany.MyApp.Server.Api.Models.Emailing;

namespace MyCompany.MyApp.Server.Api.Controllers;
...
public partial class AuthController : AppControllerBase
{
    ...
    {
        var resendDelay = (DateTimeOffset.Now - user.ConfirmationEmailRequestedOn) - AppSettings.Value.IdentitySettings.ConfirmationEmailResendDelay;
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("MyCompany.MyApp.Server.Api.Resources.EmailConfirmation.cshtml",
        ...
        , CancellationToken cancellationToken)
    {
        ...
        var resendDelay = (DateTimeOffset.Now - user.ResetPasswordEmailRequestedOn) - AppSettings.Value.IdentitySettings.ResetPasswordEmailResendDelay;
        ...
        var result = await _fluentEmail
            ...
            .UsingTemplateFromEmbedded("MyCompany.MyApp.Server.Api.Resources.ResetPassword.cshtml",
